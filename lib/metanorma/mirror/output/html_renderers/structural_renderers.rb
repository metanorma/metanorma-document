      ...
      module HtmlRenderers
        module StructuralRenderers
          def self.register(registry)
            ...
            registry.register_node_handler("preface",
                                           instance_method(:render_preface))
            registry.register_node_handler("sections",
                                           instance_method(:render_sections))
            registry.register_node_handler("bibliography",
                                           instance_method(:render_bibliography))
            registry.register_node_handler("footnotes",
                                           instance_method(:render_footnotes))
            registry.register_node_handler("soft_break",
                                           instance_method(:render_soft_break))
          end
          ...
          def render_preface(node, depth: 0)
            HtmlRenderers.build do |doc|
              doc.section(class: "mn-preface") do
                HtmlRenderers.embed(doc, render_children(node, depth:))
              end
            end
          end
          ...
          def render_sections(node, depth: 0)
            HtmlRenderers.build do |doc|
              doc.section(class: "mn-sections") do
                HtmlRenderers.embed(doc, render_children(node, depth:))
              end
            end
          end
          ...
          def render_bibliography(node, depth: 0)
            HtmlRenderers.build do |doc|
              doc.section(class: "mn-bibliography") do
                HtmlRenderers.embed(doc, render_children(node, depth:))
              end
            end
          end
