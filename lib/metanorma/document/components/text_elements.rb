  ...
  module Document
    module Components
      module TextElements
        ...
        autoload :EmphasisElement, "#{__dir__}/text_elements/emphasis_element"
        ...
        autoload :SubscriptElement, "#{__dir__}/text_elements/subscript_element"
        ...
        autoload :TextElementType, "#{__dir__}/text_elements/text_element_type"
        autoload :UnderlineElement, "#{__dir__}/text_elements/underline_element"
      end
    end
  end
end
