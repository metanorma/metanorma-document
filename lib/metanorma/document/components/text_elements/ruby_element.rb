    ...
    module Components
      module TextElements
        ...
        class RubyElement < TextElement
          attribute :ruby_paren, Metanorma::Document::Components::DataTypes::LocalizedString,
                    collection: true
          attribute :ruby_text, Metanorma::Document::Components::DataTypes::LocalizedString,
                    collection: true
