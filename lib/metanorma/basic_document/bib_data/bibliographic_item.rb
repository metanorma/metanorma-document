    ...
    module BibData
      ...
      class BibliographicItem < Lutaml::Model::Serializable
        ...
        attribute :link, Metanorma::Document::Relaton::TypedUri,
                  collection: true
        attribute :docidentifier,
                  Metanorma::Document::Relaton::DocumentIdentifier, collection: true
        ...
        attribute :note, Metanorma::Document::Relaton::TypedNote,
                  collection: true
        attribute :language,
                  Metanorma::Document::Components::DataTypes::Iso639Code, collection: true
        attribute :script,
                  Metanorma::Document::Components::DataTypes::Iso15924Code, collection: true
        attribute :abstract,
        ...
        attribute :copyright,
                  Metanorma::Document::Relaton::CopyrightAssociation, collection: true
