...
module SpecFlavors
  # Test double: exactly what metanorma-iso ships as
  # Metanorma::Iso::Html::Renderer. The harness suite uses it to
  # exercise the register_flavor seam end-to-end while lib/
  # stays flavor-free (see the portability spec).
  class IsoRenderer < Metanorma::Html::StandardRenderer
  ...
  class BipmRenderer < IsoRenderer
    ...
    register_render Metanorma::StandardDocument::Sections::Preface, :render_preface
    register_render Metanorma::StandardDocument::Sections::ClauseSection, :render_clause
    register_render Metanorma::StandardDocument::Sections::AnnexSection, :render_annex
    register_render Metanorma::StandardDocument::Sections::ContentSection, :render_clause
    register_render Metanorma::StandardDocument::Sections::TermsSection, :render_terms_section
    register_render Metanorma::StandardDocument::Sections::BibliographySection, :render_clause
    register_render Metanorma::StandardDocument::Sections::DefinitionSection, :render_clause
  end

  class OgcRenderer < IsoRenderer
    register_render "Metanorma::Ogc::Document::Root", :render_document
    register_render "Metanorma::Standoc::Document::Sections::Preface", :render_preface
    register_render "Metanorma::Standoc::Document::Sections::ClauseSection", :render_clause
    register_render "Metanorma::Standoc::Document::Sections::AnnexSection", :render_annex
    register_render "Metanorma::Standoc::Document::Sections::ContentSection", :render_clause
    register_render "Metanorma::Standoc::Document::Sections::TermsSection", :render_terms_section
    register_render "Metanorma::Standoc::Document::Sections::BibliographySection", :render_clause
