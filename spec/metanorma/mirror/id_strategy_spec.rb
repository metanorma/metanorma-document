  ...
  describe Metanorma::Mirror::IdStrategy::Positional do
    ...
    describe "#assign_id" do
      it "preserves explicit (non-UUID) IDs" do
        element = Metanorma::StandardDocument::Sections::ClauseSection.new(id: "sec-3.2", number: "3.2")
        strategy.assign_id(element).should eq("sec-3.2")
      end

      it "derives positional ID for UUID section elements with number" do
        element = Metanorma::StandardDocument::Sections::ClauseSection.new(id: "_abc123", number: "5.4")
    ...
    describe "uuid? detection" do
      it "recognizes UUID-prefixed IDs starting with underscore" do
        element = Metanorma::StandardDocument::Sections::ClauseSection.new(id: "_abc123-def456", number: "3.1")
    ...
    describe "element_category" do
      it "categorizes ClauseSection as :section" do
        element = Metanorma::StandardDocument::Sections::ClauseSection.new(id: "_uuid1", number: "4.1")
        strategy.assign_id(element).should eq("sec-4.1")
      end

      it "categorizes ContentSection as :section" do
        element = Metanorma::StandardDocument::Sections::ContentSection.new(id: "_uuid2", number: "2.3")
        strategy.assign_id(element).should eq("sec-2.3")
      end

      it "categorizes AnnexSection as :annex" do
        element = Metanorma::StandardDocument::Sections::AnnexSection.new(id: "_uuid3", number: "A.2")
        strategy.assign_id(element).should eq("anx-A.2")
      end

      it "categorizes FigureBlock as :figure" do
        element = Metanorma::Document::Components::AncillaryBlocks::FigureBlock.new(id: "_uuid4", autonum: "5")
      ...
      it "categorizes TableBlock as :table" do
        element = Metanorma::Document::Components::Tables::TableBlock.new(id: "_uuid5", autonum: "3")
