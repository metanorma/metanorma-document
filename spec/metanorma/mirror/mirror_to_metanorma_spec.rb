...
RSpec.describe Metanorma::Mirror::MirrorToMetanorma do
  ...
  describe ".skip and .register (OCP)" do
    after do
      described_class.skipped_types.delete("my_test_type")
      described_class.builders.delete("my_test_type")
    end

    it "allows new types to be skipped via .skip" do
      described_class.skip("my_test_type")
      described_class.skipped?("my_test_type").should be(true)
    end

    it "allows new types to be registered via .register" do
      described_class.register("my_test_type") do |_node, _ctx|
