...
RSpec.describe "BUGS.sts 01: SpanElement preserves <stem> children" do
  ...
  it "preserves a fn child inside span" do
    ...
    children = child_classes(span)
    children.should include(Metanorma::Document::Components::Inline::FnElement)
  end
  ...
  it "preserves a link child inside span" do
    ...
    children = child_classes(span)
    children.should include(Metanorma::Document::Components::Inline::LinkElement)
  end
  ...
  it "preserves an xref child inside span" do
    ...
    children = child_classes(span)
    children.should include(Metanorma::Document::Components::Inline::XrefElement)
  end
  ...
  it "preserves a nested span child" do
    ...
    children = child_classes(span)
    children.should include(Metanorma::Document::Components::Inline::SpanElement)
  end
