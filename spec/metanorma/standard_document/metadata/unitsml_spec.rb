...
RSpec.describe "StandardDocument metadata classes" do
  describe Metanorma::StandardDocument::Metadata::Unitsml::UnitsmlRoot do
    let(:unitsml_xml) do
  ...
  describe Metanorma::StandardDocument::Metadata::Unitsml::UnitSymbol do
  ...
  describe Metanorma::StandardDocument::Metadata::Unitsml::Dimension do
  ...
  describe Metanorma::StandardDocument::Metadata::Unitsml::Prefix do
  ...
  describe Metanorma::StandardDocument::Metadata::Unitsml::Quantity do
